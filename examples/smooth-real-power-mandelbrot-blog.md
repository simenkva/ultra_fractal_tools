...
![A non-integer member of the smooth real-power Mandelbrot family](images/smooth-real-power-mandelbrot.png)
...
![The corresponding smooth real-power Julia set](images/smooth-real-power-julia.png)
